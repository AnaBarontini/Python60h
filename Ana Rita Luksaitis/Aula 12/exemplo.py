...
topo = tk.Frame(comb, bg="maroon", padx= 10, pady= 10)
topo.pack(fill= "x")
tk.Label(topo,text="Melhor combustivel.").grid(row=0,column=0)

#frame do conteúdo do app
conteudo = tk.Frame(comb, bg = "black", padx= 10, pady= 10)
conteudo.pack(fill= "both", expand="True")

tk.Label(conteudo, text="Álcool R$", font= ("Arial, 16")).grid(row= 0, column= 0, padx= 5, pady= 5)
...
rodape = tk.Frame(comb, bg= "maroon", padx= 10, pady= 10)
rodape.pack(fill= "x")
